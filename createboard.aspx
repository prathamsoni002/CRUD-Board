...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="welcome-section">
            <span>
                <a href="Userhomepage.aspx" style="text-decoration: none; color: inherit;">
                    <img width="50px" src="imgs/back%20icon.png" />
                </a>
            </span>
            <center>
                <span style="margin-left:385px;"> Let's Create a new Board &nbsp &nbsp &nbsp</span>
            </center>
        </div>
    </header>
    <br />
    ...
    <div class="joinboard-container">
        <div class="form-container">
            ...
            <div class="form-row">
                <div class="label">Confirm your Board Secret Key:</div>
