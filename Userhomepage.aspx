...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <header class="header-user-hp">
        <div class="welcome-section">
            ...
            <span id="user-name">
                <asp:LinkButton ID="username_link" runat="server" CssClass="custom-link-button" OnClick="username_link_Click" >Test</asp:LinkButton>
            </span>
        </div>
                ...
                <ItemTemplate>
                    <div class="board-item-template">
                        <div class="individual-covering">
                            ...
                            <div class="leave-board-btn" onclick='showLeaveBoardConfirmationPopup("<%# Eval("Name") %>")'>X</div>
                        </div>
                    </div>
                </ItemTemplate>
                <FooterTemplate>
