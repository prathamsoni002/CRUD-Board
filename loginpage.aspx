                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <br />
                                <center>
                                    <asp:Button class="btn btn-success btn-block btn-lg" ID="Button1" runat="server" Text="Login" OnClick="Button1_Click" UseSubmitBehavior="false" />
                                </center>
                                <br />
                                <center>
                                    <asp:Button class="btn btn-info btn-block btn-lg" ID="Button2a" runat="server" Text="Sign Up" OnClick="Button2a_Click" UseSubmitBehavior="false" />
                                </center>
                            </div>
                        </div>
                    </div>
